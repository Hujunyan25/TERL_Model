...
"}")
        ...
        self.groupBox.setGeometry(QtCore.QRect(30, 420, 701, 171))
        ...
        self.Evader_Num_LineEdit.setMinimumSize(QtCore.QSize(0, 30))
        ...
        self.Obstacle_Num_LineEdit.setMinimumSize(QtCore.QSize(0, 30))
        ...
        self.R_Perception_lineEdit.setMinimumSize(QtCore.QSize(0, 30))
